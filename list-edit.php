...
if ($_SERVER['REQUEST_METHOD']=== 'GET') {
    ...
    $sql = 'UPDATE list SET brand_skincare=?, jenis_skincare=?, harga=?, recommendation_skincare=?, tanggal_pembelian=?, jam_pembelian=? WHERE id = ?';
    $row = $koneksi->execute_query($sql,[$brand_skincare, $jenis_skincare, $harga, $recommendation_skincare, $tanggal_pembelian, $jam_pembelian, $id]);
